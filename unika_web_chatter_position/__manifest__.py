...

{
    ...
    "assets": {
        "web.assets_backend": [
            "/unika_web_chatter_position/static/src/scss/chatter_position.scss",
            "/unika_web_chatter_position/static/src/scss/attachment_viewer.scss",
            "/unika_web_chatter_position/static/src/js/form_chatter_position.js",
        ],
        "web.assets_qweb": [
            "/unika_web_chatter_position/static/src/xml/form_buttons.xml",
        ],
    },
    "installable": True,
    "auto_install": False,
